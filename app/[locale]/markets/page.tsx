...
export default async function MarketsPage({ params }: { params: Promise<{ locale: Locale }> }) {
  ...
  return (
    <>
      ...
      <HeroBanner eyebrow="Markets" title="Mercados de Chile y Sudamerica" summary="Paginas por pais con industrias, minerales, condiciones ambientales, logistica y confirmacion electrica." />
