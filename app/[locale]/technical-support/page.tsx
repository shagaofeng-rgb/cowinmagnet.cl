...
export default async function TechnicalSupportPage({ params }: { params: Promise<{ locale: Locale }> }) {
  ...
  return (
    <>
      ...
      <HeroBanner eyebrow="Technical Support" title="Guias de seleccion, instalacion y mantenimiento" summary="Soporte tecnico para compradores B2B sin inventar parametros, certificaciones ni casos." image="/assets/products/cbs-drawer-type-magnetic-filter/cbs-drawer-type-magnetic-filter-01.jpg" />
