...
export default async function AdminBlogPage({ searchParams }) {
  ...
  return (
    <section className="admin-panel">
      <div className="admin-page-head compact"><div><p className="eyebrow">Blog 文章</p><h1>Blog 发布管理</h1><p>管理真实 CMS 数据库文章、分类、封面、状态和发布时间。</p></div></div>
      {params?.saved ? <div className="admin-alert good">文章已保存。</div> : null}
      {params?.error ? <div className="admin-alert">请填写标题和可用 Slug。</div> : null}
