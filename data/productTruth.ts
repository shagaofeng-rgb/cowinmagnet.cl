...
const sharedSelection = [
  "Material y granulometría máxima",
  "Capacidad y espesor de la capa",
  "Ancho y velocidad de la cinta",
  "Punto de instalación y espacio disponible",
...
export const productTruthCards: Record<string, ProductTruthCard> = {
  "rcyd-type-permanent-magnet-self-dumping-iron-remover": {
    ...
    esTitle: "Separador magnético permanente autolimpiante RCYD",
    equipmentType: "Separador magnético suspendido de sobrebanda",
    magnetType: "permanente", discharge: "autolimpiante",
    installation: ["Sobre cinta transportadora, en disposición transversal o longitudinal según el punto de transferencia"],
    principle: "Un circuito magnético permanente atrae el hierro trampa desde el flujo transportado. Una banda de descarga independiente retira de forma continua el material ferroso capturado fuera de la cinta principal.",
    applications: ["Protección de chancadores", "Retiro de hierro trampa en minerales y áridos", "Correas de plantas de reciclaje y manejo de graneles"],
    options: ["Disposición transversal o longitudinal", "Protección anticorrosiva definida por el ambiente", "Configuración mecánica validada con el espacio disponible"],
    verifiedSpecifications: [{ label: "Serie", value: "RCYD" }, { label: "Fuente magnética", value: "Imanes permanentes" }, { label: "Descarga de hierro", value: "Banda autolimpiante" }],
    selectionInputs: sharedSelection,
    limitations: ["La distancia de trabajo y la capa de material condicionan la captura", "No se publican fuerza magnética, capacidad ni dimensiones sin validar el modelo"],
    faqs: [
  ...
  "rcyb-type-permanent-magnet-manual-iron-remover": {
    ...
    esTitle: "Separador magnético permanente suspendido RCYB de limpieza manual",
    equipmentType: "Separador magnético suspendido", magnetType: "permanente", discharge: "manual",
    ...
    applications: ["Líneas con carga baja o intermitente de hierro trampa", "Protección de equipos aguas abajo"],
    options: ["Disposición de suspensión adaptada a la estructura", "Protección superficial según el ambiente"],
    verifiedSpecifications: [{ label: "Serie", value: "RCYB" }, { label: "Fuente magnética", value: "Imanes permanentes" }, { label: "Limpieza", value: "Manual" }],
    selectionInputs: sharedSelection,
  ...
  "rcdb-type-self-cooling-plate-electromagnetic-iron-remover": {
    ...
    esTitle: "Separador electromagnético suspendido RCDB de limpieza manual",
    equipmentType: "Electroimán suspendido", magnetType: "electromagnetico", discharge: "manual",
    installation: ["Sobre cinta o punto de transferencia, con acceso para limpieza"],
    principle: "Una bobina energizada crea el campo magnético que captura hierro trampa. El hierro acumulado se retira manualmente con el equipo desenergizado y bajo un procedimiento seguro.",
    applications: ["Protección de chancadores y molinos", "Minerales, carbón y materiales a granel"],
    options: ["Tensión y frecuencia según el proyecto", "Gabinete de control compatible con el alcance eléctrico", "Protección ambiental sujeta a revisión técnica"],
    verifiedSpecifications: [{ label: "Serie", value: "RCDB" }, { label: "Fuente magnética", value: "Bobina electromagnética" }, { label: "Limpieza", value: "Manual" }],
    selectionInputs: [...sharedSelection, "Tensión y frecuencia disponibles"],
    limitations: ["Requiere alimentación eléctrica y control", "Potencia, aislamiento y comportamiento térmico se confirman para el modelo seleccionado"],
    faqs: [
  ...
  "rcdd-type-self-cooling-self-dumping-electromagnetic-iron-remover": {
    ...
    esTitle: "Separador electromagnético autolimpiante RCDD",
    equipmentType: "Separador electromagnético suspendido de sobrebanda", magnetType: "electromagnetico", discharge: "autolimpiante",
    ...
    applications: ["Protección continua de chancadores", "Correas con presencia recurrente de hierro trampa", "Minería, áridos y manejo de graneles"],
    options: ["Tensión y frecuencia por proyecto", "Gabinete y protección eléctrica según alcance", "Configuración de descarga adaptada al layout"],
    verifiedSpecifications: [{ label: "Serie", value: "RCDD" }, { label: "Fuente magnética", value: "Bobina electromagnética" }, { label: "Descarga de hierro", value: "Banda autolimpiante" }],
    selectionInputs: [...sharedSelection, "Tensión y frecuencia disponibles", "Régimen de trabajo y acceso de mantenimiento"],
  ...
  "wet-drum-magnetic-separator": {
    ...
    esTitle: "Separador magnético de tambor húmedo para procesamiento de minerales",
    equipmentType: "Separador magnético de tambor húmedo", magnetType: "permanente", discharge: "proceso continuo",
  ...
  "dry-drum-magnetic-separator": {
    ...
    esTitle: "Separador magnético de tambor seco para minerales y materiales a granel",
    equipmentType: "Separador magnético de tambor seco", magnetType: "permanente", discharge: "proceso continuo",
  ...
  "belt-high-gradient-magnetic-separator": {
    ...
    esTitle: "Separador magnético de banda de alto gradiente",
    equipmentType: "Separador magnético de alta intensidad", magnetType: "no aplica", discharge: "proceso continuo",
  ...
  "disc-magnetic-separator-for-tailing": {
    ...
    esTitle: "Separador magnético de discos para minerales y relaves secos",
    equipmentType: "Separador magnético de discos", magnetType: "no aplica", discharge: "proceso continuo",
