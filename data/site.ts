...
export const uiText: Record<Locale, {
  ...
  "es-cl": {
    nav: {
      ...
      productText: "Productos principales organizados en cuatro familias: equipos suspendidos, separacion magnetica, reciclaje y componentes magneticos.",
  ...
  "pt-br": {
    nav: {
      ...
      productText: "Produtos principais organizados em quatro familias: equipamentos suspensos, separacao magnetica, reciclagem e componentes magneticos.",
  ...
  en: {
    nav: {
      ...
      productText: "Core products organized into four families: suspended equipment, magnetic separation, recycling and magnetic components.",
