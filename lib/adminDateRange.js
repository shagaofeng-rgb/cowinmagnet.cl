...
export function getAdminDateRange(params = {}) {
  ...
  let startInput = subtractCalendarDays(today, 6);
  let endInput = today;
  ...
  if (requestedPreset === "day") {
    ...
    startInput = subtractCalendarDays(today, 29);
    label = "本月";
  } else if (requestedPreset === "quarter") {
    startInput = subtractCalendarDays(today, 89);
    label = "近 90 天";
